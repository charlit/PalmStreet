// Fonction Netlify : journalise qui ouvre PalmStreet (navigateur, appareil,
...
const STORE_NAME = "palmstreet-visits";
const KEY = "log";
const MAX_ENTRIES = 300;

// Change ce mot de passe pour consulter la liste des visites depuis le navigateur.
// Exemple d'utilisation : https://TON-SITE.netlify.app/api/visits?key=TON_MOT_DE_PASSE
const VIEW_SECRET = "palmstreet-charles-2026";
